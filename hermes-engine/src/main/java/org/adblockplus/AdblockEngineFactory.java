...
public class AdblockEngineFactory
{
  ...
  private org.adblockplus.android.AdblockEngineBuilder adblockEngineBuilder;
  ...
  private synchronized org.adblockplus.android.AdblockEngineBuilder getBuilder()
  {
    ...
    if (adblockEngineBuilder == null)
    {
      adblockEngineBuilder =
        new org.adblockplus.android.AdblockEngineBuilder(context, appInfo, basePath);
    }
   ...
   */
  @NotNull
  public org.adblockplus.android.AdblockEngineBuilder getAdblockEngineBuilder() throws IllegalStateException
  {
    return getBuilder();
  }
