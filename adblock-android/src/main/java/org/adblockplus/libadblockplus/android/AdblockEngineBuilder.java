...
public class AdblockEngineBuilder implements org.adblockplus.AdblockEngineBuilder,
  org.adblockplus.AsyncAdblockEngineBuilder
{
  ...
  public synchronized void dispose()
  {
    ...
    ((org.adblockplus.libadblockplus.android.AdblockEngine) adblockEngine).dispose();
    adblockEngine = null;
  ...
  public synchronized State build(@NotNull final ExecutorService executorService)
  {
    ...
    executorService.submit(new Runnable()
    {
      ...
      public void run()
      {
        ...
        org.adblockplus.libadblockplus.android.AdblockEngine adblockEngineLocalRef;
        synchronized (AdblockEngineBuilder.this)
        {
          adblockEngineLocalRef =
            ((org.adblockplus.libadblockplus.android.AdblockEngine) AdblockEngineBuilder.this.adblockEngine);
  ...
  public synchronized State dispose(@NotNull final ExecutorService executorService)
  {
    ...
    executorService.submit(new Runnable()
    {
      ...
      public void run()
      {
        ...
        final org.adblockplus.libadblockplus.android.AdblockEngine adblockEngineLocalRef;
        synchronized (AdblockEngineBuilder.this)
        {
          adblockEngineLocalRef =
            ((org.adblockplus.libadblockplus.android.AdblockEngine) AdblockEngineBuilder.this.adblockEngine);
  ...
  private org.adblockplus.libadblockplus.android.AdblockEngine buildInternal()
  {
